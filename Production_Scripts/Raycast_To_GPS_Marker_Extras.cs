...
public void Main(string arg) {
    ...
    if (Camera.CanScan(RaycastDistance) && arg.ToLower() == "mark") { // Raycast
        ...
        if (!DetectedEntityInfo.IsEmpty()) {
            ...
            WaypointName += " (Name: " +  DetectedEntityInfo.Name + ", ";
            WaypointName += "Dimensions: " + (DetectedEntityInfo.BoundingBox.Size).ToString("0.0"); + ", ";
            WaypointName += "Relationship: " + DetectedEntityInfo.Relationship.ToString() + ", ";
            WaypointName += "EntityID: " + DetectedEntityInfo.EntityId.ToString() + ")";
